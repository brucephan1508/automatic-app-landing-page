...
If you enable optional features (for example cloud sync, sign-in, or analytics) or grant permissions, we will update this Policy and notify you.
...
Cached thumbnails and previews to speed up browsing.

App preferences and settings (UI preferences, last viewed folder, language, etc.).
...
Unique device identifiers (for example IDFA if advertising is enabled) and crash/reporting data.

Usage analytics (features used, pages/screens visited, session length).

This information helps us troubleshoot problems, analyze usage patterns, and improve the App. Where required by local law, we will rely on legitimate interests or your consent for this processing in the Designated Countries.
...
To provide customer support: Respond to your questions, troubleshoot, and handle disputes.

To send service-related communications: Administrative messages that are not promotional (you cannot opt out of these).

For security and fraud prevention: Detect and prevent abuse, spam, and unauthorized access.

To comply with law and enforce our rights: Respond to legal requests and protect the rights, property, or safety of users.

To personalize and improve the experience: Remember preferences, and when enabled, provide personalized features.

For research and development: Analyze aggregated usage to improve and build features.

For marketing (only with consent/opt-out available): Send promotional messages or targeted communications; you may opt out of marketing at any time.

If we use your personal information for any purpose not listed here we will disclose it to you.
...
To opt out of targeted advertising on iOS, use the system setting to limit ad tracking or deny ATT permission.

Third-party services (ad networks, analytics, crash-reporting) have their own privacy policies — we recommend reviewing them.
...
When you choose to share or upload content (for example, when you export or publish a mod file using an in-app feature).

For legal reasons: to comply with law, respond to lawful requests, protect safety, or enforce our rights.

If we share data with third parties (other than the ad/analytics providers listed in this policy), we will update this Policy and disclose the recipients.
...
Delete downloaded mod files or cached content via the App or by uninstalling the App.
...
• Any unauthorized actions (re-uploading or downloading of content) and/or intellectual property violations are the sole responsibility of the user. Downloading copyrighted files without permission may be illegal in your jurisdiction.
